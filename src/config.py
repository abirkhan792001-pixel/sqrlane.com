...
# sqrlane-operations) that reads this API from the browser. Browsers only let
...
# Where the dashboard lives. Every "Open the demo" link on the site goes to /app,
# which redirects here - so moving the dashboard is this one setting. Until the
# app.sqrlane.com DNS record exists, Vercel sets DASHBOARD_URL to the project's
